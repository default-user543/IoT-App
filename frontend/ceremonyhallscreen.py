...
class CeremonyHallScreen(Screen):
    def __init__(self, **kwargs):
        super(CeremonyHallScreen, self).__init__(**kwargs)
        layout = FloatLayout()
        self.add_widget(layout)

        self.set_window_size()
        self.bg = Image(source='ceremonyhall.png', keep_ratio=False, allow_stretch=True)
        ...
        # Username
        name = Label(
            text='Welcome to the Ceremony Hall!',
        ...
        texts = "The oval-shaped hall with a capacity of 1,000 people is an ideal venue for receptions, welcomes, and graduation ceremonies."
        ...
        image_sources = ['ceremonyhall1.png', 'ceremonyhall2.png', 'ceremonyhall3.png', 'ceremonyhall4.png']  # Thay bằng đường dẫn ảnh của bạn
    ...
    def set_window_size(self):
        img = CoreImage('ceremonyhall.png')
