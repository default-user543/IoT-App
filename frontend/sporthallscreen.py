...
class SportHallScreen(Screen):
    def __init__(self, **kwargs):
        super(SportHallScreen, self).__init__(**kwargs)
        layout = FloatLayout()
        self.add_widget(layout)

        self.set_window_size()
        self.bg = Image(source='sporthall.png', keep_ratio=False, allow_stretch=True)
        ...
        # Username
        name = Label(
            text='Welcome to the VGU Sports Hall!',
        ...
        texts = "The VGU Sports Hall, part of the university's extensive sports complex, is a modern and well-equipped facility that supports a wide variety of sporting activities. The hall features a multifunctional indoor arena with high-quality flooring and adjustable markings, suitable for basketball, volleyball, badminton, and futsal. Advanced lighting and ventilation systems provide a comfortable and safe environment for athletes. There are also seating areas for spectators, making the hall ideal for tournaments and community events. Adjacent to the hall are changing rooms with showers and ample equipment storage, providing additional convenience for users. This facility reflects VGU's commitment to promoting an active lifestyle and improving the well-being of students, staff, and the surrounding community."
        ...
        image_sources = ['sporthall1.png', 'sporthall2.png', 'sporthall3.png', 'sporthall4.png', 'sporthall5.png', 'sporthall6.png']  # Thay bằng đường dẫn ảnh của bạn
