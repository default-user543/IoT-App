...
class ForgetpwImageScreen(Screen):
    def __init__(self, **kwargs):
        ...
        # Thêm hình ảnh cho trang fp bằng ảnh đăng nhập
        login_image = Image(
            source='login.png',
        ...
        keyword_input = self.create_rounded_input("Keyword")

        # Thêm các khung nhập liệu vào BoxLayout
        input_layout.add_widget(username_input)
        input_layout.add_widget(keyword_input)

        # Thêm nút "Submit" để quay lại trang login
        ...
        # Thêm sự kiện khi nhấp vào nút "Submit"
        submit_button.bind(on_press=self.go_back_to_changepassword_image)
        ...
        back_button.bind(on_press=self.go_back_to_login_image)
    ...
    def go_back_to_changepassword_image(self, instance):
        # Quay lại màn hình cp
        self.manager.current = 'changepassword_image'



# Màn hình đăng nhập
class ForgetpwScreen(Screen):
    def __init__(self, **kwargs):
        super(ForgetpwScreen, self).__init__(**kwargs)
        ...
        # Thêm nút "Submit" để tới thay đổi mật khẩu
        submit_button = Button(
            text="Submit",
            size_hint=(None, None),
            size=(100, 50),
        ...
        # Thêm sự kiện khi nhấp vào nút "Submit"
        submit_button.bind(on_press=self.go_back_to_submit)
    ...
    def go_back_to_submit(self, instance):
        # Tới màn hình thay đổi mật khẩu
