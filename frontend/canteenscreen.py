...
class CanteenScreen(Screen):
    def __init__(self, **kwargs):
        super(CanteenScreen, self).__init__(**kwargs)
        layout = FloatLayout()
        self.add_widget(layout)

        self.set_window_size()
        self.bg = Image(source='canteen.png', keep_ratio=False, allow_stretch=True)
        ...
        texts = "The modern 3-storey dining area fully serves the rich and diverse culinary needs of domestic and international students, lecturers and staff."
        ...
        image_sources = ['canteen1.png', 'canteen2.png', 'canteen3.png', 'canteen4.png']  # Thay bằng đường dẫn ảnh của bạn
