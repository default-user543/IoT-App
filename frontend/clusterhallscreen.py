...
class ClusterHallScreen(Screen):
    def __init__(self, **kwargs):
        super(ClusterHallScreen, self).__init__(**kwargs)
        layout = FloatLayout()
        self.add_widget(layout)

        self.set_window_size()
        self.bg = Image(source='clusterhalls.png', keep_ratio=False, allow_stretch=True)
        ...
        # Username
        name = Label(
            text='Welcome to the Cluster Hall!',
        ...
        texts = "5 academic buildings arranged side by side. Each building has international standard offices and laboratories of various sizes, equipped with state-of-the-art equipment and instruments for interdisciplinary research."
        ...
        image_sources = ['clusterhalls1.png', 'clusterhalls2.png', 'clusterhalls3.png', 'clusterhalls4.png', 'clusterhalls5.png', 'clusterhalls6.png']  # Thay bằng đường dẫn ảnh của bạn
    ...
    def set_window_size(self):
        img = CoreImage('clusterhalls.png')
