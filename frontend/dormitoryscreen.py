...
class DormitoryScreen(Screen):
    def __init__(self, **kwargs):
        super(DormitoryScreen, self).__init__(**kwargs)
        layout = FloatLayout()
        self.add_widget(layout)

        self.set_window_size()
        self.bg = Image(source='dormitory.png', keep_ratio=False, allow_stretch=True)
