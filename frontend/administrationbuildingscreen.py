...
class AdministrationBuildingScreen(Screen):
    def __init__(self, **kwargs):
        super(AdministrationBuildingScreen, self).__init__(**kwargs)
        layout = FloatLayout()
        self.add_widget(layout)

        self.set_window_size()
        self.bg = Image(source='adminbuilding.png', keep_ratio=False, allow_stretch=True)
        ...
        # Username
        name = Label(
            text='Welcome to the Administration Building!',
        ...
        image_sources = ['adminbuilding1.png']  # Thay bằng đường dẫn ảnh của bạn
    ...
    def set_window_size(self):
        img = CoreImage('adminbuilding.png')
